...
class CreateNearWalletScreen extends StatefulWidget {
  @override
  State<CreateNearWalletScreen> createState() => _CreateNearWalletScreenState();
}

class _CreateNearWalletScreenState extends State<CreateNearWalletScreen> {
  String accountId = "";
          ...
          !isLoading
              ? ButtonType(
                  ...
                  press: () async {
                    ...
                    WalletApi.createNearWalletAddress(accountId)
                        .then((value) async {
